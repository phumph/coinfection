...
Here we record the steps for processing demultiplexed 16S sequencing reads, in the form of .fastq files, and calling sub-OTUs (sOTUs) via the `DADA2` algorithm (Callahan et al. 2016). We will briefly review the theory in supplemental methods, but here our main objective is to carry out the QC and sOTU assignment.
